    ...
    <>
        ...
        <div className="container landing-hero-content">
          <div className="landing-copy">
            <span className="eyebrow light">
              OASIS EDUCARES • MEDICAL EDUCATION
            </span>
            <div className="hero-country-pill">🇧🇬 BULGARIA</div>
            <h1>
              STUDY
              <br />
              <span>MBBS IN BULGARIA</span>
            </h1>
            <h2>Your Dream of Becoming a Doctor Starts Here</h2>
            <p>
              Pursue your medical degree in Europe with internationally
              recognised universities, world-class education, modern
              infrastructure and affordable tuition fees.
            </p>
            <div className="hero-actions">
              <Link className="btn primary" to="/mbbs-in-bulgaria">
                Explore MBBS in Bulgaria <ArrowRight size={18} />
              </Link>
              <Link className="btn white-outline" to="/apply">
                Book Free Counselling <CalendarIcon />
              </Link>
            </div>
          </div>

          <div className="hero-bulgaria-card">
            <div className="flag-circle">🇧🇬</div>
            <div>
              <strong>BULGARIA</strong>
              <span>
                A Smart Choice for Your
                <br />
                Medical Career
              </span>
            </div>
      ...
      <section className="section why-section" id="why-bulgaria">
        <div className="container why-grid">
          <div className="why-panel">
            ...
            <Link className="btn light-btn" to="/mbbs-in-bulgaria">
              Know More About Bulgaria <ArrowRight size={16} />
            </Link>
          </div>
      ...
      <section className="section journey-section" id="process">
        <div className="container">
          <div className="journey-heading">
            <span>YOUR JOURNEY TO BECOME A DOCTOR</span>
          </div>
          <div className="journey-strip">
            {medicalJourney.map((j, i) => (
              <div className="journey-step" key={j.number}>
                <div className="journey-number">{j.icon}</div>
                <small>{j.number}</small>
                <strong>{j.title}</strong>
                {i < medicalJourney.length - 1 && (
                  <ArrowRight className="journey-chevron" size={17} />
                )}
              </div>
            ))}
          </div>
      ...
      <section className="support-section">
        <div className="container support-banner">
          ...
          <div>
            <span className="eyebrow light">OASIS EDUCARES</span>
            <h2>We make your dream of becoming a doctor a reality!</h2>
            <p>
              Personalised guidance for students and parents at every step of
              the medical education journey.
            </p>
          </div>
          <Link className="btn light-btn" to="/apply">
        ...
        <div className="container">
          <div className="section-heading-row">
            <div>
              ...
              <h2>Explore Medical Universities in Bulgaria</h2>
              <p>Compare leading institutions offering Medicine in English.</p>
            </div>
            <Link className="btn outline" to="/universities">
          ...
          <div className="mini-university-grid">
            {universities.slice(0, 4).map((u) => (
              <Link to="/universities" className="mini-university" key={u.id}>
                <div className="mini-university-icon">
                  <GraduationCap />
                </div>
                <span>🇧🇬 {u.city}</span>
                <h3>{u.name}</h3>
                <small>{u.programme} · {u.duration}</small>
                <b>
        ...
        <div className="container">
          <div className="section-heading-row">
            <div>
              ...
              <h2>What Our Medical Students Say</h2>
              <p>
                Real experiences from students who trusted Oasis Educares with
            ...
            >
              View Existing Testimonials <ArrowRight size={16} />
            </button>
          </div>

          <div className="testimonial-grid">
            {testimonials.slice(0, 4).map((t) => {
              const profile = testimonialProfiles[t.name] || {};
              const testimonialText = profile.text || t.text;
      ...
      <section className="cta">
        <div className="container cta-inner">
          <div>
            <span className="eyebrow light">START YOUR MEDICAL JOURNEY</span>
            <h2>Ready to explore MBBS in Bulgaria?</h2>
            <p>Talk to Oasis Educares and take the first step.</p>
          </div>
          <Link className="btn light-btn" to="/apply">
